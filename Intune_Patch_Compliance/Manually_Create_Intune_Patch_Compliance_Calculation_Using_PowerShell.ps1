...
<Manually_Create_Intune_Patch_Compliance_Calculation_Using_PowerShell>
INPUTS
<Provide all required inforamtion in User Input Section-line No 27 & 29 >
OUTPUTS
...
$DeviceList = "C:\TEMP\IntunePatchingReport\D.csv" # Location of Intune Device data csv file

...
# This script installs the Quincy QUIC tunnel
#
# It installs the quincy client and server binaries and config files
# and generates a random username and password for the client config
#
# It also updates the mtu value in the client and server config files
# and removes the 'examples/' directory from the path in the config files
